...
def test_notify_only_browse(download_mock):
    gran_polys = [
        ...
        ('POLYGON((-122.374016 40.047749,-121.967674 38.427338,-119.047066 '
            '38.829082,-119.382103 40.448418,-122.374016 40.047749))'),
        ('POLYGON((-145.369354 67.583824,-144.403641 66.114708,-138.803253 '
            '66.584755,-139.426422 68.070457,-145.369354 67.583824))'),
        ('POLYGON((151.06724688555676 -24.528223362574582,163.02037188555676 '
            '-26.432299499496587,164.60240313555676 '
            '-37.858451843817015,146.32115313555676 '
            '-35.03097612917617,151.06724688555676 -24.528223362574582))'),
        ('POLYGON((163.11227482192282 -32.992958890226774,-178.25491267807718'
            ' -35.32001562618694,177.70211857192282 '
            '-43.07125968935438,160.12399357192282 '
            '-40.583050605123454,163.11227482192282 -32.992958890226774))')
    ]
